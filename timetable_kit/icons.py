...
def get_baggage_icon_html(_embedded_svg=False, doing_html=True) -> str:
    """
    Return suitable HTML for displaying the baggage icon.

    If doing_html=False, return a suitable capital letter
    """
    return baggage_span_str if doing_html else baggage_letter
...
def get_accessible_icon_html(doing_html=True) -> str:
    ...
    """
    return accessible_span_str if doing_html else accessible_letter
...
inaccessible_span_str = (
    f'<span class="inaccessible-symbol" {inaccessible_img_str}</span>'
)
...
def get_inaccessible_icon_html(doing_html=True) -> str:
    ...
    """
    return inaccessible_span_str if doing_html else inaccessible_letter
...
def get_bus_icon_html(doing_html=True) -> str:
    ...
    """
    return bus_span_str if doing_html else bus_letter
...
def get_sleeper_icon_html(doing_html=True) -> str:
    ...
    """
    return sleeper_span_str if doing_html else sleeper_letter
