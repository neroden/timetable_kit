...
def run():
    ...
    Merge Amtrak and Hartford Line data into a joint GTFS, "hartford_line/merged-
    gtfs.zip". Assumes that Hartford Line and Amtrak data have already been downloaded
    by amtrak/get_gtfs.py and hartford_line/get_gtfs.py.
    """
