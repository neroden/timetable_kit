...
The table itself is layed out in the module timetable_styling using Pandas's Styler to
apply CSS classes. This fills in the symbol key and text around it to make a full page.
