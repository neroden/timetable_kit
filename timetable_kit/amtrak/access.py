...
"""Make various dicts from station code to various station accessibility
features.
...
def station_wheelchair_boarding_gtfs_code(station_code: str) -> int:
    """What is the correct GTFS wheelchair boarding code number for the
    station? 0 = unknown 1 = accessible, for at least some services 2 =
    explicitly inaccessible Does the station explicitly have an inaccessible
    platform?
...
def patch_add_wheelchair_boarding(feed: FeedEnhanced):
    """Patch an Amtrak GTFS feed to add the wheelchair boarding information
    from Amtrak's JSON stations database.
