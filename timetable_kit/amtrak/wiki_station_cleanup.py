...
This is not being used but is preserved in case it might come in handy
later. It is therefore full of hardcoded filenames, and probably subject
to bitrot. It is better to get station names from Amtrak's JSON data.
"""
