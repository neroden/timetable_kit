...
def make_station_stats():
    ...
    with open(station_stats_dir / "possible_features.txt",'w') as possible_features_file:
    ...
    with open(station_stats_dir / "possible_accessibility.txt",'w') as possible_accessibility_file:
        possible_accessibility_file.write('\n'.join(sorted(possible_accessibility)))

    with open(station_stats_dir / "inaccessible_platforms.txt",'w') as inaccessible_platforms_file:
    ...
    interesting_no_wheelchair_lifts = low_platform_no_wheelchair_lifts - inaccessible_platforms

    with open(station_stats_dir / "no_wheelchair_lifts.txt",'w') as no_wheelchair_lifts_file:
